...
# /api/v3/notifications/* er flyttet til src/api/routers/notifications.py
...
# /api/v3/evidence/* og /api/v3/cases/{}/evidence/* er flyttet til
# src/api/routers/evidens.py


# =========================================================================
# Skabelon-bibliotek og evidens-comments er flyttet til
# src/api/routers/skabeloner.py og src/api/routers/comments.py
