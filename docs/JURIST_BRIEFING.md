# Jurist-briefing — Hjemmel v3 sektorlov-arbejde

*5 min læsning før interview*

## Hvad er Hjemmel?

Hjemmel er Kalundborg Kommunes interne AI-compliance-platform der vurderer kommunale AI-projekter mod EU AI Act, GDPR og dansk lov inden idriftsættelse.
...
5. Sagsbehandlere kan udfylde predikat-svar i Hjemmel og få afgørelser hjemlet i din arbejde

Det betyder også: når du siger noget i et interview-svar, ender det som **bindende krav** i Hjemmel-systemet. Det er den modsatte af "uforpligtende rådgivning" — vi koder din juridiske vurdering ind i et produktionssystem.
...
— Hjemmel-team / Digitalisering og IT
